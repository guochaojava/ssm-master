...
(function(window) {
  ...
  var _bridge = function() {
    ...
    if (!container) {
      ...
      tmpDiv.innerHTML = '<object id="global-zeroclipboard-flash-bridge" name="global-zeroclipboard-flash-bridge" ' + 'width="100%" height="100%" ' + (oldIE ? 'classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000"' : 'type="application/x-shockwave-flash" data="' + swfUrl + '"') + ">" + (oldIE ? '<client name="movie" value="' + swfUrl + '"/>' : "") + '<client name="allowScriptAccess" value="' + allowScriptAccess + '"/>' + '<client name="allowNetworking" value="' + allowNetworking + '"/>' + '<client name="menu" value="false"/>' + '<client name="wmode" value="transparent"/>' + '<client name="flashvars" value="' + flashvars + '"/>' + "</object>";
