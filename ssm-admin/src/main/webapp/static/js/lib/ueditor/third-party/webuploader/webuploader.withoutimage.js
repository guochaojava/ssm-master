...
(function( root, factory ) {
    ...
    define('widgets/widget',[
        ...
        /**
         * 添加组件
         * @client  {object} widgetProto 组件原型，构造函数通过constructor属性定义
         * @client  {object} responseMap API名称与函数实现的映射
         * @example
         *     Uploader.register( {
        ...
        Base.inherits( Runtime, {
            ...
            init: function() {
                ...
                html += 'width="100%" height="100%" style="outline:0">'  +
                    '<client name="movie" value="' + opts.swf + '" />' +
                    '<client name="flashvars" value="uid=' + this.uid +
                    '&jsreciver=' + this.jsreciver + '" />' +
                    '<client name="wmode" value="transparent" />' +
                    '<client name="allowscriptaccess" value="always" />' +
                '</object>';
